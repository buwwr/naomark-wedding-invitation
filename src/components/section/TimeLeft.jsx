...
export default function TimeLeft() {
    ...
    const renderer = ({ days, hours, minutes, seconds, completed }) => {
        if (completed) {
            return (
            <section className="bg-[#f8eae1] p-5">
                <div className="font-sans card glass py-5">
            ...
            <section className="bg-[#f8eae1] p-5">
                <div className=" flex justify-center">
                    <div className="grid grid-flow-col auto-cols-max gap-3 md:gap-5 text-center justify-center">
                        <div className="flex flex-col p-2 bg-neutral rounded-box text-neutral-content font-sans">
